...
const JOURNEYS: Array<{
  ...
  },
  {
    ...
    icon: "🏛️",
    label: "Schemes",
    description: "Check eligibility for welfare.",
  },
  {
    id: "cpgrams",
    icon: "📮",
    label: "Grievance",
    description: "Prepare a government complaint.",
  },
  {
    id: "rights",
    icon: "🧭",
    label: "Rights",
    description: "Tenant, consumer, workplace.",
  },
];
  ...
  return (
    <div className="flex flex-col gap-4 px-4">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="text-center">
        <h2 className="text-xl font-bold gradient-text-hero">Your Cases &amp; Actions</h2>
        <p className="mx-auto mt-1 max-w-xl text-xs leading-relaxed" style={{ color: "var(--color-text-muted)" }}>
          Select a path below, or go back to chat to describe your situation and we&apos;ll route you automatically.
        </p>
      </motion.div>
